...
public class YesIDo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonYesIDoContinue= findViewById(R.id.button_yesIDoContinue);

        buttonYesIDoContinue.setOnClickListener(this);
    }
